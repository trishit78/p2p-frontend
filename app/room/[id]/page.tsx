...
export default function RoomIdPage({
  ...
  const [, setIsYjsConnected] = useState(false);
  ...
  return (
    <div className="h-screen bg-white dark:bg-gray-900 flex flex-col">
      ...
      {token && (
        <div className="h-70 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 p-4">
      ...
      {!token && (
        <div className="h-70 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
